...
uses Unit_logon, Unit_pesquisa_turmas, Unit_DMPrincipal,
  Unit_Rel_AlunosPorTurma;
...
begin
  ...
  begin
    sql:= 'SELECT TURMAS.COD_TURMA AS TURMA, '+
     ...
     Form_Rel_AlunosPorTurma.QuickRep1.Preview;
...
procedure TForm_rel_alunos.btn_todosClick(Sender: TObject);
var sql : string;
begin
  edt_turma.Clear;
    sql:= 'SELECT TURMAS.COD_TURMA AS TURMA, '+
