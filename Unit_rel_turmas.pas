...
uses Unit_logon, Unit_pesquisa, Unit_DMPrincipal, Unit_Rel_TurmasPorCurso;
...
begin
  ...
  begin
    sql := ' SELECT CURSOS.NOME AS CURSO, '+
     ...
     Form_Rel_TurmasPorCurso.QuickRep1.Preview;
...
procedure TForm_rel_turmas.btn_todosClick(Sender: TObject);
var sql: string;
begin
    edt_curso.Clear;
